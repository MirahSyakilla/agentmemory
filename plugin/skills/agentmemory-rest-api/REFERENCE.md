...
| GET | `/agentmemory/artifacts` |
| POST | `/agentmemory/artifacts` |
| POST | `/agentmemory/artifacts/get` |
| POST | `/agentmemory/artifacts/search` |
...
| POST | `/agentmemory/conflicts/resolve` |
| POST | `/agentmemory/consolidate` |
| POST | `/agentmemory/consolidate-pipeline` |
| POST | `/agentmemory/context` |
| POST | `/agentmemory/context-reduction/events` |
| GET | `/agentmemory/context-reduction/stats` |
...
| GET | `/agentmemory/evidence` |
| POST | `/agentmemory/evidence` |
| POST | `/agentmemory/evidence/get` |
| POST | `/agentmemory/evidence/search` |
| POST | `/agentmemory/evidence/verify` |
| POST | `/agentmemory/evolve` |
| GET | `/agentmemory/experiments` |
| POST | `/agentmemory/experiments` |
| POST | `/agentmemory/experiments/expand` |
| POST | `/agentmemory/experiments/get` |
| POST | `/agentmemory/experiments/search` |
| POST | `/agentmemory/experiments/update` |
...
| POST | `/agentmemory/graph/temporal-query` |
...
| POST | `/agentmemory/memories/temporal-query` |
...
| GET | `/agentmemory/negative-memories` |
| POST | `/agentmemory/negative-memories` |
| POST | `/agentmemory/negative-memories/lookup` |
...
| POST | `/agentmemory/retrieval/expand` |
| POST | `/agentmemory/retrieval/plan` |
...
| POST | `/agentmemory/session/turn-end` |
